...
class Rectangle:
    ...
    def width(self, value):
        """Makes the width of the rectangle."""
    ...
    def height(self, value):
        """Makes the height of the rectangle."""
        if not isinstance(value, int):
            raise TypeError("height must be an integer")
        if value < 0:
            raise ValueError("height must be >= 0")
    ...
    def __str__(self):
        """Provides a rectangle with the print_symbol attribute."""
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """Provides a string representation of an instance."""
